...
class Board extends _react.Component {
  constructor(_ref) {
    ...
    (0, _defineProperty2.default)(this, "getStore", () => {
      ...
      return (0, _redux.legacy_createStore)(_BoardReducer.default, (0, _redux.applyMiddleware)(...middlewares));
    });
    this.store = this.getStore();
    this.id = id || (0, _uuid.v1)();
  }
  render() {
    var {
      id,
    ...
    var allClassNames = (0, _classnames.default)('react-ui-kanban-board', className || '');
